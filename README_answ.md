...
1. Готовый playbook находится здесь: 

2. Скрин выполнения `ansible-lint site.yml` (ошибки были исправлены ранее):

![alt text](img/2024-12-18_20-27-18.png)
...
![alt text](img/2024-12-18_20-33-43.png)
...
![alt text](img/2024-12-19_00-46-08.png)

5. Скрин повторного запуска playbook с флагом `--diff` - playbook идемпотентен:

![alt text](img/2024-12-19_00-47-42.png)
